...
const Dashboard = () => {
  ...
  return (
    <div className={dashboardStyles.page}>
              ...
              <div className={dashboardStyles.formFields}>
                  ...
                  <div className={dashboardStyles.levelGrid}>
                    {levels.map((lvl) => (
                      <button key={lvl.value} onClick={() => {
                        ...
                        ${level === lvl.value ?
                            `${lvl.bg} border-2
                      ${lvl.color.replace("text", "border")
                            }` : "border-gray-200 hover:border-grey-300"
                          }`}
                        type="button"
                      >
                        <span className={`${dashboardStyles.levelButtonTextBase}
                          ${level === lvl.value ? lvl.color : "text-grey-600"
                          }`}>
                          {lvl.value}
                        </span>
                      </button>
                ...
                <div>
                  ...
                  <div
                    ...
                    className={`${dashboardStyles.dropzoneBase} ${isDragging
                  ...
                  >
                    ...
                    />
                    <Upload
                      className={`${dashboardStyles.uploadIconBase} ${isDragging
                          ...
                          <div className={dashboardStyles.optionsGrid}>
                            {q.options.map((opt, oi) => {
                              ...
                              return (
                                <div
                                  key={oi}
                                  className={`${dashboardStyles.optionItemBase} ${isCorrect
                                ...
                                >
                                  <div className="flex items-center gap-3">
                                    <div
                                      className={`${dashboardStyles.optionLetterBase} ${isCorrect
            ...
            <div className={dashboardStyles.summaryCard}>
              ...
              <div className={dashboardStyles.summaryRows}>
                ...
                <div className={dashboardStyles.summaryRow}>
                  ...
                  <span
                    className={`${dashboardStyles.summaryValue} ${level === "Basic"
                      ? "text-green-600"
                      : level === "Intermediate"
                        ? "text-yellow-600"
                        : "text-red-600"
                ...
                <div className={dashboardStyles.summaryStatusRow}>
                  ...
                  <span
                    className={`${dashboardStyles.statusBadgeBase} ${isFormValid
      ...
      {toast.show && (
        <div
          className={`${dashboardStyles.toastOuter} ${toast.show
              ? dashboardStyles.toastVisible
              : dashboardStyles.toastHidden
            }`}
        >
          <div
            className={`${dashboardStyles.toastInner} ${toast.type === "success"
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p
                  className={`${dashboardStyles.toastTextBase} ${toast.type === "success"
